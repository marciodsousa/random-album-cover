...
(function (a, b) {
  if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (b),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ("undefined" != typeof exports) b();else {
    b(), a.FileSaver = { exports: {} }.exports;
  }
})(undefined, function () {
  "use strict";
  function b(a, b) {
    return "undefined" == typeof b ? b = { autoBom: !1 } : "object" != (typeof b === "undefined" ? "undefined" : _typeof(b)) && (console.warn("Deprecated: Expected third argument to be a object"), b = { autoBom: !b }), b.autoBom && /^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(a.type) ? new Blob(["\uFEFF", a], { type: a.type }) : a;
  }function c(b, c, d) {
...
var _domToImage = __webpack_require__(0);
...
document.getElementById("buttonToClick").addEventListener("click", function () {
    ...
    _domToImage2.default.toBlob(document.getElementById('my-node')).then(function (blob) {
        (0, _fileSaver.saveAs)(blob, 'my-node.png');
    });
});
